...
async function resolveEmbedInstance(supabase, embedId, sig) {
    ...
    try {
        result = await supabase
            .from('manufacturer_embed_instances')
            .select('id, manufacturer_id, name, embed_key, embed_secret, prototype_asset_id, allowed_origins, rate_limit_per_ip_hour, daily_cap, monthly_cap, is_active, show_on_media_wall')
            .eq('embed_key', key)
            .maybeSingle();
    } catch (e) {
