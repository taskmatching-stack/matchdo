    ...
    if (items.length < limit) {
        try {
            let pq = supabase
                ...
                .select('id, manufacturer_id, title, description, ai_tags, image_url, image_url_before, show_on_media_wall, created_at')
            ...
            const visiblePorts = await manufacturerAudience.filterPortfolioRowsForAudience(supabase, ports || [], { internalPreview: false });
