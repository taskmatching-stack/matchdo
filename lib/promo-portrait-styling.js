...
function buildPortraitNoLensFlareGuard() {
    return (
        'Do not add or keep lens flare, light spots, sun stars, anamorphic streaks, ghosting, light leaks, '
        + 'or floating bright orbs. Remove any flare or sparkle overlays; do not paint specular blobs into the air.'
    );
}
