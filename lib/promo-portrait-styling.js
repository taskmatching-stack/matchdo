...
/** 原圖衣著：商用構圖（英文，僅 reference 清晰／Gemini lead） */
...
/** 三模式共用：商用構圖（中文，氛圍／混合貼人；不進 scene/prompt 英文 lead） */
...
/** 清晰 Gemini：scene/prompt 補中文商用構圖（reference 已在英文 lead 開頭） */
function buildPortraitCommercialFramingClearGeminiLine(mode) {
    ...
    return buildPortraitCommercialFramingMoodLine(m);
}
