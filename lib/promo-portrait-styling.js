...
function buildPortraitWholeFrameExposureCloser(cameraBlock) {
    ...
    const base =
        ...
        + 'Scene mood words (cool tone, haze, lifted shadows, private interior) describe color and atmosphere only; '
        + 'they must not override this EV for overall brightness.';
    if (stops > 0) {
