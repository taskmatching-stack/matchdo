...
const DEFAULT_PROMPTS = {
    prototype_tagging_prompt: `你是產品視覺與訂製品類專家。請分析這張「產品數位原型／版型」圖片。
輸出僅一段 JSON，不要 markdown，格式如下：
{
  "tags": ["標籤1", "標籤2"],
  "category_guess": "品類英文或中文",
  "style_keywords": ["風格關鍵字"],
  "materials": ["材質"],
  "colors": ["主色描述"],
  "structure": ["結構特徵"],
  "mood": ["氛圍"],
  "intent_summary": "一句話摘要",
  "locale": "zh-TW"
}
tags 陣列 8～15 個，含品類、材質、風格、結構、用途，中英皆可。`,
...
tags 5～15 個。`,
    ...
    generated_image_semantics_prompt: `你是產品視覺分析師。請分析這張「AI 生成產品圖」的視覺風格（非提示詞文字）。
輸出僅一段 JSON，格式同 prototype 分析（含 tags 8～15 個、style_keywords、colors、materials、intent_summary）。`
};
