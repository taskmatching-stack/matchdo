...
const MATERIAL_PROMPT_VERSION = 'v6-material-universal';
...
function buildMaterialFluxFidelityLine(semanticsJson) {
    ...
    appendField('finish', s.craftsmanship);
    if (s.intent_summary) {
    ...
    return `Preserve exactly what Gemini read from the reference image (do not invent or alter): ${parts.join('; ')}.`;
}
