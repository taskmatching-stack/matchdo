...
function ensureSubBucket(map, subcategoryKey, subNameByKey) {
    ...
    } else if (subNameByKey && subcategoryKey && subNameByKey[subcategoryKey]) {
...
function aggregateSimpleCategoryUsage(items, categories, opts) {
    ...
    (items || []).forEach(function (item) {
        ...
        if (bucket) {
            ...
            const sub = ensureSubBucket(bucket.subcategories, item.subcategory_key, bucket.subNameByKey);
