...
function pageShell(opts) {
    ...
    return '<!DOCTYPE html>\n<html lang="' + htmlLang + '">\n<head>\n' +
        ...
        '.help-prose .help-table-wrap{overflow-x:auto;margin:0 0 1rem;-webkit-overflow-scrolling:touch;}\n' +
        '.help-prose table.help-table{width:100%;border-collapse:collapse;font-size:.95rem;}\n' +
        '.help-prose table.help-table th,.help-prose table.help-table td{border:1px solid #dee2e6;padding:.4rem .55rem;vertical-align:top;}\n' +
        '.help-prose table.help-table th{background:#f8f9fa;font-weight:600;}\n' +
