...
function pageShell(opts) {
    ...
    return '<!DOCTYPE html>\n<html lang="' + htmlLang + '">\n<head>\n' +
        ...
        jsonLd +
        '<style>\n' +
        '.help-prose h2{font-size:1.15rem;margin-top:1.5rem;}\n' +
        '.help-prose h3{font-size:1.05rem;margin-top:1.15rem;}\n' +
        '.help-anchor{font-size:.8rem;opacity:.45;text-decoration:none;margin-left:.25rem;}\n' +
