...
const MIGRATIONS = [
    ...
    },
    {
        ...
        title: '操作介紹：寬鬆尺度（大尺度產品）',
        description: '寬鬆尺度給大尺度產品用，限方案三／方案四，並更新外部擋圖說明（內部 key 仍為 experiment）',
    ...
    },
    {
        ...
        title: '操作介紹：寬鬆尺度全站頻率與禁止裸露',
        description: '寫明寬鬆尺度禁止裸露；較忙時頁面才出短提醒',
