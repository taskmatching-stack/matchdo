        ...
        (async function () {
            try {
                ...
                if (mc && typeof mc === 'object') {
                    ...
                    if (mc.main_material || (mc.main && mc.main.material)) {
                        writeLine(doc, font, '主色材質', mc.main_material || (mc.main && mc.main.material));
                    }
                    if (mc.accent_material || (mc.accent && mc.accent.material)) {
                        writeLine(doc, font, '配色材質', mc.accent_material || (mc.accent && mc.accent.material));
                    }
