        ...
        (async function () {
            try {
                ...
                if (resume.selected_options && resume.selected_options.length) {
                    doc.font(font).fontSize(11).fillColor('#000000').text('選項');
                    doc.moveDown(0.15);
                    resume.selected_options.forEach(function (o) {
                        writeLine(doc, font, o.label, o.value);
                    });
                    doc.moveDown(0.2);
                }
                ...
                if (audience === 'admin' && prompts.final_prompt && prompts.final_prompt !== prompts.user_prompt) {
