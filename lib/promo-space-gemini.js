...
function buildPromoPortraitGeminiPrompt(opts) {
    ...
    if (origUserPrompt) {
        let stylingDetails = origUserPrompt;
        if (o.blockRetryClothingAdjust === true) {
            stylingDetails += ' ' + promoPortraitStyling.buildPortraitBlockRetryClothingHintZh(
                o.stylingMode || o.portrait_styling_mode
            );
        }
        parts.push('Styling and details: ' + stylingDetails);
    } else {
        const poseLine = promoPortraitStyling.buildPortraitPoseBySceneGeminiLine(o.themeKey);
        if (poseLine) parts.push(poseLine);
        if (o.blockRetryClothingAdjust === true) {
            parts.push(promoPortraitStyling.buildPortraitBlockRetryClothingHintZh(
                o.stylingMode || o.portrait_styling_mode
            ));
        }
    }
    ...
    if (o.blockRetryClothingAdjust === true) {
        parts.push(promoPortraitStyling.buildPortraitBlockRetryClothingGeminiLine(
            o.stylingMode || o.portrait_styling_mode
        ));
    }
