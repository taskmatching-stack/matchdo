...
function buildPromoPortraitGeminiPrompt(opts) {
    ...
    parts.push(
        ...
        + 'Clothing, hairstyle, accessories, pose, body stance, camera framing, and background/environment may follow the user description and theme — '
        + 'do not keep the reference background or pose unless the camera settings explicitly require keeping the reference angle.'
    );
