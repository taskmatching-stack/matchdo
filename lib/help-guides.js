...
const helpHtmlSanitize = require('./help-html-sanitize');

function escapeHtml(s) {
    return helpHtmlSanitize.escapeHtml(s);
}
...
function looksLikeHtml(s) {
    return helpHtmlSanitize.looksLikeHtml(s);
}

function sanitizeHelpHtml(raw) {
    return helpHtmlSanitize.sanitizeHelpHtml(raw);
}
...
function renderHelpText(text, lang) {
    ...
    if (looksLikeHtml(text)) {
        return addHeadingAnchors(helpHtmlSanitize.wrapTablesForScroll(sanitizeHelpHtml(text)));
    }
