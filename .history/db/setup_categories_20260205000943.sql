...
- 若無圖片,依子分類提供標準項目清單
- 若圖片模糊,標註「依現場實際狀況調整」
- 數量估算需合理(避免過度報價)', '["清潔服務","家電 燈具","廚房","門片 拉門","木工 油漆 壁紙","泥作 圍藝","家事服務","搬家 回收","抓漏防水","櫥櫃 家具","消毒除蟲","地板 地毯 磁磚","鐵作 採光罩","寵物","水電工程","衛浴","窗戶 窗簾","室內設計與裝潢","其他裝修工程","保全防盜"]'::jsonb),
...
- 無圖片時提供標準配置建議
- 依人數規模調整服務項目
- 標註備註選項(如備用音響/天氣備案)', '["婚禮籌備","場地 餐飲","設備租賃","活動協助","攝影服務","娛樂表演"]'::jsonb),
...
- 無圖片時提供該類別標準課程配置
- 考量學習進度與難易度分級
- 標註試聽/體驗課選項', '["鋼琴 鍵盤樂器","國樂課程","設計課程","個人成長","理工 商管課程","證照課程","弦樂課程","歌唱 樂理","才藝課程","各科家教","電腦課程","行銷課程","管樂 打擊樂課程","繪畫課程","舞蹈課程","語言課程","美容相關課程","其他課程"]'::jsonb),
...
- 無圖片時提供該類別基礎配置
- 考量安全性與漸進式訓練
- 標註體驗課選項', '["健身雕塑","武術運動","健康諮詢","美容美髮","運動"]'::jsonb),
...
- 無圖片時提供該類別標準服務包
- 標註交付時程與修改制度
- 區分初稿/精修/定稿階段', '["行銷服務","印刷 招牌","網頁 程式","嵌入式開發","資料輸入 校稿","紙紮諮詢","人力支援","拍照攝影","平面設計","IT相關服務","商業空間設計","音樂製作","企業補助顧問","影片製作","多媒體設計","工業設計","翻譯服務","職涯成長","公司業務支援"]'::jsonb),
...
- 無圖片時提供該子類別常見服務
- 標註保固/額外收費項目
- 建議現場勘查再報價', '["3C維修","汽車 機車","代辦服務","交通運輸","服飾配件","樂器維修","手工製作"]'::jsonb)
