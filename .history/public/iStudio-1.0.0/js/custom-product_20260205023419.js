        ...
        try {
            ...
            if (result.success) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text text-success">
                                <i class="fas fa-check-circle me-2"></i>圖片生成成功
                            </p>
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="retryGeneration()">
                ...
                $('#generatedImagePreview').html(`
                    <div class="alert alert-danger">
                        ...
                        <button type="button" class="btn btn-sm btn-danger" onclick="retryGeneration()">
                            <i class="fas fa-redo me-1"></i>重試
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-secondary ms-2" onclick="switchToUpload()">
            ...
            $('#generatedImagePreview').html(`
                <div class="alert alert-warning">
                    ...
                    <button type="button" class="btn btn-sm btn-warning" onclick="retryGeneration()">
                        <i class="fas fa-redo me-1"></i>重試
                    </button>
                </div>
            `);
