        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="/custom-product.html" class="nav-item nav-link">客製產品</a>
                    ...
                    ${user ? `
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light m-0">
                                ...
                                <a href="/expert/dashboard.html" class="dropdown-item">
                                    <i class="bi bi-speedometer2 me-2"></i>專家控制台
                                </a>
                                <a href="/expert/my-listings.html" class="dropdown-item">
                                    <i class="bi bi-list-ul me-2"></i>我的報價
                                </a>
                                <a href="/expert/matched-projects.html" class="dropdown-item">
                                ...
                                <a href="/client/my-projects.html" class="dropdown-item">
                                    <i class="bi bi-folder me-2"></i>我的專案 (草稿/發佈)
                                </a>
                                <div class="dropdown-divider"></div>
                                <h6 class="dropdown-header"><i class="bi bi-palette me-2"></i>客製產品</h6>
                                <a href="/custom-product.html" class="dropdown-item">
                                    <i class="bi bi-plus-circle me-2"></i>建立新產品
                                </a>
                                <a href="/client/my-custom-products.html" class="dropdown-item">
                    ...
                    ${user ? `
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="/expert/dashboard.html">
                                    <i class="bi bi-speedometer2 me-2"></i>專家控制台
                                </a></li>
                                <li><a class="dropdown-item" href="/expert/my-listings.html">
                                    <i class="bi bi-list-ul me-2"></i>我的報價
                                </a></li>
                                <li><a class="dropdown-item" href="/expert/matched-projects.html">
                                    <i class="bi bi-lightning me-2"></i>媒合專案
                                </a></li>
                                ...
                                <li><a class="dropdown-item" href="/client/my-custom-products.html">
                                    <i class="bi bi-box-seam me-2"></i>我的客製產品
                                </a></li>
                                <li><hr class="dropdown-divider"></li>
