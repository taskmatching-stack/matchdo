...
(function () {
    ...
    if (el && !el.innerHTML) {
        ...
        el.innerHTML = '<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">' +
            '<a href="' + brandUrl + '" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5"><img src="/img/matchdo-logo.png" alt="MatchDO 合做" style="height:36px;width:auto;"></a>' +
