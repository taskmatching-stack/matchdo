...
async function renderHeader(headerContainer, user, config, meCapabilitiesPreloaded, renderOpts) {
    ...
    var helpHref = (navLang === 'en') ? '/help/?lang=en' : '/help/';
                    ...
                    ${showMyFeaturesDropdown ? `
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light m-0" style="min-width:15rem;">
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="${helpHref}" class="dropdown-item"><i class="bi bi-question-circle me-2"></i>` + (t('nav.operationGuides') || '操作介紹') + `</a>
                            </div>
                        </div>
                    ` : ''}
                    ...
                    ${user ? `
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdownDesktop">
                                ...
                                <li><a class="dropdown-item" href="${helpHref}"><i class="bi bi-question-circle me-2"></i>` + (t('nav.operationGuides') || '操作介紹') + `</a></li>
                                ...
                                <li><a class="dropdown-item" href="/admin/operation-guides.html"><i class="bi bi-journal-text me-2"></i>` + (t('nav.operationGuides') || '操作介紹') + `</a></li>
