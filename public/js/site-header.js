...
(function injectSiteHeaderStyles() {
    if (!document.getElementById('morandi-global-css')) {
        ...
        _m.rel = 'stylesheet';
        _m.href = '/css/morandi-global.css?v=2';
    ...
    if (!document.getElementById('nb-css')) {
        ...
        _c.textContent = [
            ...
            '.navbar{padding:15px 0;font-family:"Space Grotesk",sans-serif;font-size:18px;border-bottom:1px solid rgba(123,143,161,0.32);}',
            '.navbar .navbar-nav .nav-link{margin-left:30px;padding:0;outline:none;color:#333;}',
            '.navbar .navbar-nav .nav-link .nav-hover-caret{color:var(--bs-primary,#7B8FA1);font-size:16px;line-height:1;vertical-align:middle;margin-left:4px;opacity:.6;transition:opacity .15s;}',
            '.navbar .navbar-nav .nav-link:hover .nav-hover-caret,.navbar .navbar-nav .nav-link.active .nav-hover-caret{opacity:1;}',
            '.navbar .navbar-nav .nav-link:hover,.navbar .navbar-nav .nav-link.active{color:var(--bs-primary,#7B8FA1)!important;}',
            '.navbar .dropdown-toggle::after{display:none!important;}',
            '.navbar .dropdown-menu .dropdown-item:hover,.navbar .dropdown-menu .dropdown-item.active{background:var(--bs-primary,#7B8FA1)!important;color:#fff!important;}',
            ...
            '.nav-hover-menu .dropdown-item:hover{background:var(--bs-primary,#7B8FA1)!important;color:#fff!important;}',
            ...
            '#site-header .navbar-collapse{order:1;width:100%;flex-grow:1;border-bottom:1px solid rgba(107,101,96,0.14);}',
            ...
            '#site-header .nav-avatar-toggle::after{display:block!important;margin-left:0;margin-top:2px;color:var(--bs-primary,#7B8FA1)!important;border-top-color:var(--bs-primary,#7B8FA1)!important;}',
            '}'
        ].join('');
...
async function renderHeader(headerContainer, user, config, meCapabilitiesPreloaded, renderOpts) {
    ...
    var brandTaglinesHtml = siteBrandTaglinesHtml(t);
    const navHTML = `
        <!-- Navbar Start -->
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
            <a href="${brandUrl}" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5 ${user ? 'd-lg-none' : ''}">
                ...
                ${user ? '' : '<div class="site-brand-taglines-host ms-2 d-none d-xl-flex">' + brandTaglinesHtml + '</div>'}
            </a>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <div class="nav-item dropdown nav-has-hover">
                        ...
                        <div class="dropdown-menu nav-hover-menu">
                            ...
                            <a href="/custom-product.html?tab=vendor-styles" class="dropdown-item"><i class="bi bi-grid-3x3-gap"></i>` + t('nav.browseVendorStyles') + `</a>
                    ...
                    ${user ? `
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdownDesktop">
                                ...
                                <li><a class="dropdown-item" href="/client/manufacturer-materials.html?official_platform=1"><i class="bi bi-collection me-2"></i>官方版型庫</a></li>
                                ` : '') + `
                                ` : ''}
                                <li><hr class="dropdown-divider"></li>
            ...
            ${user ? `<div class="nav-second-row-wrap d-none d-lg-flex align-items-center px-0 py-1" style="order:2;flex:0 0 100%;width:100%;"><div class="nav-second-row-left d-flex align-items-center justify-content-end pe-2" style="flex:1;min-width:0;overflow:hidden;">${brandTaglinesHtml}</div><a href="${brandUrl}" class="navbar-brand d-flex align-items-center px-4" style="flex:0 0 auto;border:none !important;"><img src="/img/matchdo-logo.png" alt="MatchDO 合做" style="height:52px;width:auto;"></a><div class="nav-second-row-right d-flex align-items-center justify-content-end px-4" style="flex:1;min-width:0;"><a href="/credits.html" class="nav-points-desktop text-decoration-none small text-muted" title="${t('nav.myCredits') || '我的點數'}"><i class="bi bi-currency-exchange me-1"></i><span id="navPointsDesktopValue">—</span> 點</a></div></div>` : ''}
        </nav>
