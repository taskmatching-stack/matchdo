                    ...
                    ${user ? `
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdownDesktop">
                                ...
                                <li><a class="dropdown-item" href="/custom-product.html?tab=promo-camera"><i class="bi bi-camera me-2"></i>` + (t('nav.promoCamera') || '攝影模擬') + `</a></li>
