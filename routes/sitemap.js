...
function registerSitemapRoutes(app, deps) {
    ...
    const SITEMAP_PAGES = [
        ...
        { path: '/promo-camera/product',   priority: '0.75', changefreq: 'monthly' },
        { path: '/promo-camera/space',    priority: '0.75', changefreq: 'monthly' },
        { path: '/promo-camera/portrait', priority: '0.75', changefreq: 'monthly' },
        { path: '/promo-camera-app',        priority: '0.72', changefreq: 'monthly' },
        { path: '/promo-camera-app/product',   priority: '0.7', changefreq: 'monthly' },
        { path: '/promo-camera-app/space',    priority: '0.7', changefreq: 'monthly' },
        { path: '/promo-camera-app/portrait', priority: '0.7', changefreq: 'monthly' },
