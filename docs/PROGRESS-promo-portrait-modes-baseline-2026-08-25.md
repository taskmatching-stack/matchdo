...
- **尺度：** 對齊 Gemini 生圖禁止項與 BFL FLUX Usage Policy。生圖已帶商用構圖／`***不要情色感***` 後，**潤飾門檻提高**：時裝／泳裝／內衣、商業親密、以及「脫外套」這類外層衣物預設不改寫。成人全裸／性行為／露性器官才潤飾。硬擋與節流不變。未成年任何性化＝硬擋、不改寫。實名公眾人物＋裸露／性化改寫成匿名成人模特。不改主題／場景／鏡頭封裝。
