...
**同時生效：** RPM／TPM／RPD（以及 Tier 花費窗）任一觸發即 **429**，不是只看其中一個。
...
#### 外部參考表（Nano Banana **Pro**，勿與上表混用）

坊間／整理文件常見（**Pro**／`gemini-3-pro-image` 量級，非本測試兩模組）：

| 指標 | 免費層（常見寫法） | Tier 1（常見寫法） |
|------|--------------------|--------------------|
| RPM | 5～10 | ~300 |
| TPM | ~250K | 更高 |
| RPD | 50～250 | 1,000～1,500 |

- 本測試用的是 **Flash／Flash Lite**，你 AI Studio 實測是 **RPM 100／150、RPD 1000**，**以 AI Studio 為準**  
- Pro 的「Tier1 RPM ~300」**不適用**於自動套到 Flash／Lite  
- 升階後 Pro／Flash 各自再查一次，勿抄通用表
