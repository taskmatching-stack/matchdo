...
('cap.textile.fabric_proc.embroidery', 'capability', 'cap.textile.fabric_proc', 2, '刺繡', ARRAY['手繡','傳統刺繡']::text[], NULL, 1004),
('cap.textile.fabric_proc.machine_embroidery', 'capability', 'cap.textile.fabric_proc', 2, '電繡', ARRAY['電腦刺繡','機繡','電腦繡']::text[], NULL, 1006),
('cap.textile.fabric_proc.embroidery_3d', 'capability', 'cap.textile.fabric_proc', 2, '立體電繡', ARRAY['3D刺繡','立體刺繡','泡棉繡']::text[], NULL, 1007),
